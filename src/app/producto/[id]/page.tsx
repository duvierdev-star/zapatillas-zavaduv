  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-5 py-6 sm:py-10">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-[#6b675f]">
          <Link href="/" className="rounded-md bg-white border border-[#e4dfd0] px-2.5 py-1 font-semibold text-[#141414] hover:bg-[#141414] hover:text-white transition">
            ← Inicio
          </Link>
          <span>/</span>
          <Link href={`/marca/${brandSlug}`} className="rounded-md bg-white border border-[#e4dfd0] px-2.5 py-1 font-bold text-[#141414] hover:bg-[#141414] hover:text-white transition">
            {product.brand}
          </Link>
          <span>/</span>
          <span className="truncate max-w-[180px] sm:max-w-none font-medium text-[#141414]">{product.name}</span>
        </div>
