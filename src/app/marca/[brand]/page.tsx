            ...
            <div className="relative overflow-hidden rounded-3xl border border-black/5 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
              ...
              <div className="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="max-w-3xl">
                  ...
                  <div className="mt-6">
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] font-black uppercase tracking-wider text-white ${isPromo ? "bg-[#141414]" : "bg-[#2754F5]"
                        }`}
                    >
                      {isPromo ? "⚡ Ofertas por tiempo limitado" : "✦ Colección oficial"}
                    </span>
                  </div>

                  {/* Title */}
                  <h1 className="mt-3 text-3xl font-black tracking-tight text-[#141414] sm:text-4xl lg:text-5xl">
                    {isPromo ? "Promociones y ofertas" : `Colección ${brandName}`}
                  </h1>
                  ...
                  <p className="mt-4 max-w-2xl text-sm leading-7 text-[#6b675f] sm:text-base">
                    ...
                    . Encuentra modelos disponibles en diferentes tallas y colores con precios
                    actualizados.
                  </p>
                    ...
                    <div className="flex items-center gap-3 rounded-2xl border border-black/5 bg-[#faf9f7] px-4 py-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-[#141414]">
                          {brandProducts.length === 1 ? "Modelo" : "Modelos"}
                        </p>
                      </div>
                    </div>
                  </div>
