...
> = {
  ...
  "Under Armour": {
    label: "Under Armour",
    tag: "Tácticas & Alto Rendimiento",
    bg: "bg-[#1b2a22]",
    text: "text-white",
    border: "border-[#1b2a22]",
  },
  Lacoste: {
    label: "Lacoste",
    tag: "Tennis Heritage",
  ...
  Timberland: {
    ...
    bg: "bg-[#4e3629]",
    text: "text-white",
    border: "border-[#4e3629]",
  },
  Fila: {
    label: "Fila",
    tag: "Sportstyle Vintage",
    bg: "bg-[#0b1354]",
    text: "text-white",
    border: "border-[#0b1354]",
  },
  "Alexander McQueen": {
    label: "Alexander McQueen",
    tag: "Luxury Fashion & Chunky",
    bg: "bg-[#1f1f1f]",
    text: "text-white",
  ...
  Alo: {
    label: "Alo",
    tag: "Modern Athleisure & Studio",
    bg: "bg-[#2d3142]",
    text: "text-white",
    border: "border-[#2d3142]",
  },
  Diesel: {
    label: "Diesel",
    tag: "Denim & Streetwear",
    bg: "bg-[#b91c1c]",
    text: "text-white",
  ...
  "Golden Goose": {
    label: "Golden Goose",
    tag: "Venetian Luxury Craft",
    bg: "bg-[#3d312a]",
    text: "text-white",
    border: "border-[#3d312a]",
  },
  "On Cloud": {
    label: "On Cloud",
    tag: "Swiss Running & CloudTec",
    bg: "bg-[#1e293b]",
    text: "text-white",
  ...
  Champion: {
    label: "Champion",
    tag: "Heritage Athletic & Lifestyle",
    bg: "bg-[#0c2340]",
    text: "text-white",
  ...
  Hoka: {
    label: "Hoka",
    tag: "Máximo Confort & Trail Running",
    bg: "bg-[#0284c7]",
    text: "text-white",
  ...
  "Miu Miu": {
    label: "Miu Miu",
    tag: "Luxury Sandals & Runway",
    bg: "bg-[#3f2e24]",
    text: "text-white",
    border: "border-[#3f2e24]",
  },
  Prada: {
    label: "Prada",
    tag: "Milano Haute Couture",
    bg: "bg-[#18181b]",
    text: "text-white",
